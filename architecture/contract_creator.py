...
def create_contract(certificators):
...
contract MARTSIAEth {
  ...
  address[%s] public attributeCertifiers=[%s];
...
""" % (len(certificators), certificators_addresses)

    with open('blockchain/contracts/MARTSIAEth_autogenerated.sol', 'w') as f:
        f.write(contract_in_string)


if __name__ == "__main__":
    create_contract([attribute_certifier_address, attribute_certifier_address2, attribute_certifier_address3])
