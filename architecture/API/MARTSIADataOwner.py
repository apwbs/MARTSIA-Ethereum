...
class MARTSIADataOwner:
    ...
    def __retrieve_data__(self, authority_address):
        ...
        public_parameters = block_int.retrieve_parameters_link(authority_address, self.process_instance_id)
        public_key = block_int.retrieve_publicKey_link(authority_address, self.process_instance_id)
